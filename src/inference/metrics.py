        ...
        if file.endswith("_target.png"):
            ...
            if os.path.exists(fake_image_path):
                ...
                if real_image.shape == fake_image.shape:
                    mse = np.mean((real_image[:, :, 2] - fake_image[:, :, 2]) ** 2)
                    rmse = math.sqrt(mse)
...
# Usage
image_folder = '/home/ai/Downloads/results/tavi_512_unaligned/test_latest/images/'
...
# B: Average MSE: 11.08862640744164, Average RMSE: 3.323801479510094
# G: Average MSE: 16.77762876238142, Average RMSE: 4.090425049072218
# R: Average MSE: 14.24498449053083, Average RMSE: 3.76856104823703
...
# B: Average MSE: 7.5183186531066895, Average RMSE: 2.719488296938165
# G: Average MSE: 14.2801144917806, Average RMSE: 3.7586947206473567
# R: Average MSE: 14.762221972147623, Average RMSE: 3.8239731353886177
